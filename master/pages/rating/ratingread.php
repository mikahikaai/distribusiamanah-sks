...
<div class="content">
  <div class="card">
    <div class="card-header">
      ...
      <!-- <a href="report/reportrating.php" target="_blank" class="btn btn-warning btn-sm float-right">
        <i class="fa fa-file-pdf"></i> Export PDF
      </a> -->
    </div>
    <div class="card-body">
      <table width="auto" id="mytable" class="table table-bordered table-hover" style="white-space: nowrap; background-color: white;">
        <thead>
          <tr>
            <th>No.</th>
            <th>Rating</th>
