...
<div class="content">
  <div class="card">
    ...
    <div class="card-body">
      <form action="?page=doDistribusiUpdate&id=<?= $_GET['id'] ?>" method="post">
        ...
        for ($i = 0; $i < $jumlah_data; $i++) { ?>
          <div class="card">
            <div class="card-header">
              ...
              <?php if ($i == $jumlah_data - 1) { ?>
                <button type="button" name="tambah_tujuan" class="btn btn-success btn-sm float-right" id="tah">
                  <i class="fa fa-plus"></i>
                <?php } else { ?>
                  <button type="button" name="hapus_tujuan" class="btn btn-danger btn-sm float-right" id="tah">
