    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="?page=datadistribusi">Distribusi</a></li>
...
<div class="content">
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Data Tambah Retur</h3>
    </div>
    <div class="card-body">
      <form action="" method="post">
        <div class="form-group">
          <label for="cari_do">Nomor Order</label>
          <input type="text" name="cari_do" class="form-control" placeholder="Masukkan Nomor Order . . ." required>
        </div>
        <div class="form-group">
          <label for="distributor">Distributor</label>
          <input type="text" name="distributor" class="form-control" disabled>
        </div>
        <div class="row">
          <div class="col-md">
            <div class="form-group">
